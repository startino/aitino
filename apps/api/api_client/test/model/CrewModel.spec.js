...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.CrewModel();
  });
  ...
  describe('CrewModel', function() {
    it('should create an instance of CrewModel', function() {
      // uncomment below and update the code to test CrewModel
      //var instance = new FastApi.CrewModel();
      //expect(instance).to.be.a(FastApi.CrewModel);
    });
