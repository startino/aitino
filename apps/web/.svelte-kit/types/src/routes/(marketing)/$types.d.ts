...
type LayoutRouteId = RouteId | "/(marketing)" | "/(marketing)/(auth)/login" | "/(marketing)/(auth)/register" | "/(marketing)/blog" | "/(marketing)/blog/(blog-article)/[slug]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(marketing)/+layout.server.js').load>>>>>>;
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(marketing)/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(marketing)/+layout.js').load>>>>>>;
