...
type RouteParams = {  };
type RouteId = '/(marketing)/blog/(blog-article)';
...
type LayoutRouteId = RouteId | "/(marketing)/blog/(blog-article)/[slug]"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(marketing)/blog/(blog-article)/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(marketing)/blog/(blog-article)/+layout.js').load>>>>>>;