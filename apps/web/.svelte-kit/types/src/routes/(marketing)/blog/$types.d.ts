...
type LayoutRouteId = RouteId | "/(marketing)/blog" | "/(marketing)/blog/(blog-article)/[slug]"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(marketing)/blog/+page.server.js').load>>>>>>;
