...
type LayoutRouteId = RouteId | "/(marketing)" | "/(marketing)/(auth)/login" | "/(marketing)/(auth)/register" | "/(marketing)/blog" | "/(marketing)/blog/(blog-article)/[slug]" | "/app" | "/app/account" | "/app/auto-build" | "/app/editor/agent" | "/app/editor/crew" | "/app/library" | "/app/library/agent" | "/app/library/crew" | "/app/sessions" | null
